...
def Seg(paragraph):
    ...
    for a in atoms:
        ...
        yield (i.decode('UTF8', errors="surrogateescape"), a.sPOS.decode('UTF8', errors="surrogateescape")) #use this line for python 3.x

if __name__ == "__main__":
    p = "与 PFNET 的整合 在引文路径识别中大量使用的技术方法之一是 寻径网络 （ Pathfinder Network，PFNET） "
    p.replace(" ","")
    p = p.encode('UTF8')
    #print(p)
    for t in Seg(p):
